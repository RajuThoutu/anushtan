                    ...
                    <div className="group relative">
                        <Card className="relative h-full bg-white border-2 border-anushtan-border p-0 overflow-hidden group-hover:-translate-y-2 transition-all duration-500 group-hover:border-anushtan-terracotta hover:shadow-[0_10px_40px_rgba(212,175,55,0.2)]">
                            <div className="h-96 w-full relative grayscale group-hover:grayscale-0 transition-all duration-700">
                                ...
                                <div className="absolute bottom-6 left-6 text-anushtan-charcoal">
                                    <h3 className="font-heading text-3xl font-bold mb-1">Iccha Shakti</h3>
                                    <p className="text-anushtan-terracotta font-medium tracking-wide">The Soul</p>
                                </div>
                            </div>
                        ...
                        <Card className="relative h-full bg-white border-2 border-anushtan-border p-0 overflow-hidden group-hover:-translate-y-2 transition-all duration-500 group-hover:border-anushtan-terracotta hover:shadow-[0_10px_40px_rgba(212,175,55,0.2)]">
                            <div className="h-96 w-full relative grayscale group-hover:grayscale-0 transition-all duration-700 bg-anushtan-parchment">
                                ...
                                <div className="absolute bottom-6 left-6 text-anushtan-charcoal">
                                    ...
                                    <p className="text-anushtan-terracotta font-medium tracking-wide">The Mind</p>
                                </div>
                            </div>
                            <div className="p-8 bg-white text-anushtan-charcoal h-full relative border-t border-anushtan-border">
                        ...
                        <Card className="relative h-full bg-white border-2 border-anushtan-border p-0 overflow-hidden group-hover:-translate-y-2 transition-all duration-500 group-hover:border-anushtan-terracotta hover:shadow-[0_10px_40px_rgba(212,175,55,0.2)]">
                            <div className="h-96 w-full relative grayscale group-hover:grayscale-0 transition-all duration-700 bg-anushtan-parchment">
                                ...
                                <div className="absolute bottom-6 left-6 text-anushtan-charcoal">
                                    ...
                                    <p className="text-anushtan-terracotta font-medium tracking-wide">The Future</p>
                                </div>
                            </div>
                            <div className="p-8 bg-white text-anushtan-charcoal h-full relative border-t border-anushtan-border">
